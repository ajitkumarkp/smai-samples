"""
Model Training Step (Decorated Version)

Same logic as train.py but with @step decorator applied at function definition.
See train.py module docstring for full documentation.
"""
