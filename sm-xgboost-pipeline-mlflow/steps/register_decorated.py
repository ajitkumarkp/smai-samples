"""
Model Registration Step (Decorated Version)

Same logic as register.py but with @step decorator applied at function definition.
See register.py module docstring for full documentation.
"""
...
def register(
    ...
    bucket,
    quality_check=None,  # ← Accept quality check result (optional for backward compatibility)
