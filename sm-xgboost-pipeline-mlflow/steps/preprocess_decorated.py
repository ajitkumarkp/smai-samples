"""
Data Preprocessing Step (Decorated Version)

Same logic as preprocess.py but with @step decorator applied at function definition.
See preprocess.py module docstring for full documentation.
"""
...
@step(name="Abalone_Data_Preprocessing")
